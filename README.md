...
* [node-red-reusable-flows](https://github.com/rozek/node-red-reusable-flows)<br>"Components" allow multiply needed flows to be defined once and then invoked from multiple places
